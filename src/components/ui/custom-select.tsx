...
export const CustomSelect: React.FC<CustomSelectProps> = ({
  ...
  return (
    <div className={cn("relative", className)} ref={selectRef}>
      ...
      {isOpen && (
        <div className="absolute top-full left-0 right-0 mt-1 bg-popover border border-border rounded-lg shadow-lg z-50 max-h-60 overflow-y-auto animate-scale-in">
          {options.map(option => (
