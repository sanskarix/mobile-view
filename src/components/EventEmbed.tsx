      ...
      <>
        <div className="space-y-4">
          ...
          <div className="flex items-center space-x-2">
            <Switch
              id="hide-details"
              checked={embedSettings.hideEventTypeDetails}
              onCheckedChange={value => handleSettingChange('hideEventTypeDetails', value)}
            />
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="flex items-center space-x-3">
                <input
                  type="color"
                  value={`#${embedSettings.lightBrandColor}`}
                  onChange={e => handleSettingChange('lightBrandColor', e.target.value.slice(1))}
                  className="w-10 h-10 border border-gray-300 rounded cursor-pointer"
                />
                <input
                  type="text"
                  value={embedSettings.lightBrandColor}
                  onChange={e => handleSettingChange('lightBrandColor', e.target.value.replace('#', ''))}
            ...
            <div>
              ...
              <div className="flex items-center space-x-3">
                <input
                  type="color"
                  value={`#${embedSettings.darkBrandColor}`}
                  onChange={e => handleSettingChange('darkBrandColor', e.target.value.slice(1))}
                  className="w-10 h-10 border border-gray-300 rounded cursor-pointer"
                />
                <input
                  type="text"
                  value={embedSettings.darkBrandColor}
                  onChange={e => handleSettingChange('darkBrandColor', e.target.value.replace('#', ''))}
                  className="flex-1 px-3 py-2 border border-gray-300 rounded-lg text-sm"
                  placeholder="fafafa"
                />
              </div>
    ...
    switch (embedType) {
        ...
        return (
          <div className="space-y-6">
            <div className="p-4 bg-gray-50 rounded-lg">
              <h4 className="font-medium mb-3">Inline Embed</h4>
              <p className="text-sm text-gray-600 mb-4">
                Embed the calendar directly into your webpage
              </p>
              {commonOptions}
            </div>
          </div>
      ...
      case 'floating':
        return (
          <div className="space-y-6">
            <div className="p-4 bg-gray-50 rounded-lg">
              <h4 className="font-medium mb-3">Floating Button</h4>
              <p className="text-sm text-gray-600 mb-4">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-2">
                  <Switch
                    id="display-icon"
                    checked={embedSettings.displayCalendarIcon}
                    onCheckedChange={value => handleSettingChange('displayCalendarIcon', value)}
                  />
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-2">
                      <input
                        ...
                        onChange={e => handleSettingChange('buttonColor', e.target.value.slice(1))}
                        className="w-8 h-8 border border-gray-300 rounded cursor-pointer"
                      />
                      <input
                        type="text"
                        value={embedSettings.buttonColor}
                        onChange={e => handleSettingChange('buttonColor', e.target.value.replace('#', ''))}
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-2">
                      <input
                        ...
                        onChange={e => handleSettingChange('textColor', e.target.value.slice(1))}
                        className="w-8 h-8 border border-gray-300 rounded cursor-pointer"
                      />
                      <input
                        type="text"
                        value={embedSettings.textColor}
                        onChange={e => handleSettingChange('textColor', e.target.value.replace('#', ''))}
                        className="flex-1 px-2 py-1 border border-gray-300 rounded text-sm"
                      />
                    </div>
                  </div>
      ...
      case 'popup':
        return (
          <div className="space-y-6">
            <div className="p-4 bg-gray-50 rounded-lg">
              <h4 className="font-medium mb-3">Pop up via element click</h4>
              <p className="text-sm text-gray-600 mb-4">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="flex items-center space-x-2">
                      ...
                      <input
                        type="text"
                        value={embedSettings.windowWidth}
                        onChange={e => handleSettingChange('windowWidth', e.target.value)}
                        className="flex-1 px-3 py-2 border border-gray-300 rounded-lg text-sm"
                      />
                    </div>
                    <div className="flex items-center space-x-2">
                      ...
                      <input
                        type="text"
                        value={embedSettings.windowHeight}
                        onChange={e => handleSettingChange('windowHeight', e.target.value)}
                        className="flex-1 px-3 py-2 border border-gray-300 rounded-lg text-sm"
                      />
                    </div>
                  </div>
      ...
      case 'email':
        return (
          <div className="space-y-6">
            <div className="p-4 bg-gray-50 rounded-lg">
              <h4 className="font-medium mb-3">Email Embed</h4>
              <p className="text-sm text-gray-600 mb-4">
        ...
        <div className="flex gap-8">
          ...
          <div className="w-2/5">
            <div className="space-y-4">
              ...
              {/* Get Code Button */}
              <div className="text-center">
                <h4 className="font-medium text-sm mb-1">Ready to embed Cal ID?</h4>
                <p className="text-xs text-gray-600 mb-3">Click below to get HTML or React codes</p>
                <button
