...
export const EventAdvanced = () => {
  ...
  return (
    <div className="p-0 max-w-none mx-auto space-y-10" style={{ fontSize: '14px', color: '#384252' }}>
      {/* Add to calendar */}
      <div className="space-y-6">
        <h3 className="font-semibold" style={{ fontSize: '16px', color: '#384252' }}>Add to calendar</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label className="block font-medium mb-3" style={{ fontSize: '14px', color: '#384252' }}>Default</label>
            <select className="w-full px-3 py-2 border border-gray-300 rounded-lg bg-white" style={{ fontSize: '14px', color: '#384252' }}>
              <option>sanskarix@gmail.com (Google Calendar - sanskarix@gmail.com)</option>
            </select>
            <p className="mt-2" style={{ fontSize: '12px', color: '#384252' }}>The calendar to add bookings to</p>
          </div>
          <div>
            <label className="block font-medium mb-3" style={{ fontSize: '14px', color: '#384252' }}>With event name</label>
            <input 
              type="text" 
        ...
        <div className="pl-6">
          <div>
            <label className="block font-medium mb-3" style={{ fontSize: '14px', color: '#384252' }}>Default</label>
            <select className="w-full max-w-md px-3 py-2 border border-gray-300 rounded-lg bg-white" style={{ fontSize: '14px', color: '#384252' }}>
              <option>sanskarix@gmail.com</option>
            </select>
            <p className="mt-2" style={{ fontSize: '12px', color: '#384252' }}>We'll display this email address as the organizer, and send confirmation emails here.</p>
          </div>
        </div>
      </div>
      ...
      <div className="border-t border-gray-200 pt-10 space-y-6">
        <div>
          ...
          <p style={{ fontSize: '14px', color: '#384252' }}>You can select multiple and your bookers can switch views.</p>
        </div>
            ...
            <div key={layout.id} className="space-y-3">
              <div 
                className={`relative p-4 border-2 rounded-lg cursor-pointer transition-all aspect-video ${
                  settings.eventLayout === layout.id ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-gray-300'
                }`} 
      ...
      <div className="border-t border-gray-200 pt-10 space-y-6">
        <div>
          ...
          <p style={{ fontSize: '14px', color: '#384252' }}>Customize the questions asked on the booking page</p>
        </div>
      ...
      {/* Settings toggles in minimal cards */}
      <div className="border-t border-gray-200 pt-10 space-y-6">
        <h3 className="font-semibold" style={{ fontSize: '16px', color: '#384252' }}>Event Settings</h3>
        
        <div className="grid gap-4">
          {/* Each toggle in a minimal card */}
          ...
          <div className="p-4 border border-gray-200 rounded-lg bg-white">
            ...
            {settings.enableCaptcha && (
              <div className="mt-4 pl-4 border-l-2 border-gray-200">
                ...
                <select className="px-3 py-2 border border-gray-300 rounded-lg bg-white" style={{ fontSize: '14px', color: '#384252' }}>
          ...
          <div className="p-4 border border-gray-200 rounded-lg bg-white">
            ...
            {settings.privateLinks && (
              <div className="mt-4 pl-4 border-l-2 border-gray-200">
                ...
                <button className="mt-3 text-blue-600 hover:text-blue-700" style={{ fontSize: '14px' }}>
                  + Add new link
                </button>
              </div>
            )}
          ...
          <div className="p-4 border border-gray-200 rounded-lg bg-white">
            ...
            {settings.offerSeats && (
              <div className="mt-4 pl-4 border-l-2 border-gray-200 space-y-4">
                ...
                <div>
                  <h4 className="font-medium mb-3" style={{ fontSize: '14px', color: '#384252' }}>Share attendee information between guests</h4>
