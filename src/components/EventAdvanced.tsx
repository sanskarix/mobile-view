  ...
  return (
    <div className="p-0 max-w-none mx-auto space-y-8">
      ...
      <div className="bg-card border border-border rounded-lg p-6">
        <h3 className="font-semibold mb-4" style={{ fontSize: '16px', color: '#384252' }}>Add to calendar</h3>
      ...
      {/* Layout section */}
      <div className="bg-card border border-border rounded-lg p-6">
        <h3 className="font-semibold mb-2" style={{ fontSize: '16px', color: '#384252' }}>Layout</h3>
        <p className="mb-6 text-muted-foreground" style={{ fontSize: '14px', color: '#6b7280' }}>
          ...
          {layoutOptions.map(layout => (
            <div key={layout.id} className="space-y-3">
              ...
              <div className="text-center">
                <label className="font-medium cursor-pointer" style={{ fontSize: '14px', color: '#384252' }}>
                  {layout.name}
                </label>
              </div>
            </div>
      ...
      <div className="bg-card border border-border rounded-lg p-6">
        <h3 className="font-semibold mb-2" style={{ fontSize: '16px', color: '#384252' }}>Booking questions</h3>
        ...
        <div className="space-y-3 mb-4">
          {bookingQuestions.map((question, index) => (
            <div key={index} className="flex items-center justify-between p-4 border border-border rounded-lg bg-background">
              ...
              <button className="text-primary hover:text-primary/80" style={{ fontSize: '14px' }}>Edit</button>
            </div>
          ))}
        </div>

        <button className="text-primary hover:text-primary/80 font-medium" style={{ fontSize: '14px' }}>
          + Add a question
        </button>
      </div>
      ...
      <div className="bg-card border border-border rounded-lg p-6 space-y-6">
        <h3 className="font-semibold mb-4" style={{ fontSize: '16px', color: '#384252' }}>Event Settings</h3>
        ...
        <div className="space-y-6">
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h4 className="font-medium" style={{ fontSize: '14px', color: '#384252' }}>Requires confirmation</h4>
                <p className="text-muted-foreground" style={{ fontSize: '14px', color: '#6b7280' }}>
          ...
          <div className="space-y-4">
            <div className="flex items-start justify-between gap-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h4 className="font-medium" style={{ fontSize: '14px', color: '#384252' }}>Enable captcha on Booking page</h4>
                  <p className="text-muted-foreground" style={{ fontSize: '14px', color: '#6b7280' }}>
          ...
          {/* Continue with other toggles in similar format */}
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-center space-x-3">
              <Switch checked={settings.requiresEmailVerification} onCheckedChange={value => handleToggle('requiresEmailVerification', value)} />
              <div>
                <h4 className="font-medium" style={{ fontSize: '14px', color: '#384252' }}>Requires booker email verification</h4>
                <p className="text-muted-foreground" style={{ fontSize: '14px', color: '#6b7280' }}>
          ...
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h4 className="font-medium" style={{ fontSize: '14px', color: '#384252' }}>Hide notes in calendar</h4>
          ...
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h4 className="font-medium" style={{ fontSize: '14px', color: '#384252' }}>Disable Cancel and Reschedule options for this event type</h4>
          ...
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h4 className="font-medium" style={{ fontSize: '14px', color: '#384252' }}>Hide calendar event details on shared calendars</h4>
          ...
          <div className="space-y-4">
            <div className="flex items-start justify-between gap-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h4 className="font-medium" style={{ fontSize: '14px', color: '#384252' }}>Redirect on booking</h4>
          ...
          <div className="space-y-4">
            <div className="flex items-start justify-between gap-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h4 className="font-medium" style={{ fontSize: '14px', color: '#384252' }}>Private Links</h4>
          ...
          <div className="space-y-4">
            <div className="flex items-start justify-between gap-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h4 className="font-medium" style={{ fontSize: '14px', color: '#384252' }}>Offer seats</h4>
          ...
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h4 className="font-medium" style={{ fontSize: '14px', color: '#384252' }}>Lock timezone on booking page</h4>
          ...
          <div className="space-y-4">
            <div className="flex items-start justify-between gap-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h4 className="font-medium" style={{ fontSize: '14px', color: '#384252' }}>Event type color</h4>
