  ...
  return (
    <div className="p-0 max-w-none mx-auto space-y-8" style={{ fontSize: '14px', color: '#384252' }}>
      ...
      <div className="border-t border-gray-200 pt-8">
        <h3 className="font-semibold mb-4" style={{ fontSize: '16px', color: '#384252' }}>Layout</h3>
        <p className="mb-6" style={{ fontSize: '14px', color: '#384252' }}>You can select multiple and your bookers can switch views.</p>
      ...
      {/* Booking questions */}
      <div className="border-t border-gray-200 pt-8">
        <h3 className="font-semibold mb-4" style={{ fontSize: '16px', color: '#384252' }}>Booking questions</h3>
        <p className="mb-6" style={{ fontSize: '14px', color: '#384252' }}>Customize the questions asked on the booking page</p>
