  ...
  return <div className="p-0 max-w-none mx-auto space-y-6">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input type="text" placeholder="Product Hunt Chats between Sanskar Yadav and {Scheduler}" className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm" />
            </div>
          </div>
        </div>
      ...
      <div className="border-t border-gray-200 pt-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          {layoutOptions.map(layout => <div key={layout.id} className="space-y-2">
      ...
      <div className="border-t border-gray-200 pt-6">
        ...
        <div className="space-y-3 mb-4">
          {bookingQuestions.map((question, index) => <div key={index} className="flex items-center justify-between p-3 border border-gray-200 rounded-lg">
              <div className="flex-1">
                <div className="flex items-center space-x-3">
                  <span className="text-sm font-medium text-gray-700">{question.label}</span>
                  <span className={`text-xs px-2 py-1 rounded-full ${question.required === 'Required' ? 'bg-red-100 text-red-800' : question.required === 'Optional' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-600'}`}>
                    {question.required}
                  </span>
                </div>
      ...
      <div className="border-t border-gray-200 pt-6 space-y-6">
        ...
        <div className="space-y-4">
          ...
          {settings.enableCaptcha && <div className="pl-4">
        ...
        <div className="space-y-4">
          ...
          {settings.redirectOnBooking && <div className="mt-4 pl-4">
              <input type="url" value={settings.redirectUrl} onChange={e => setSettings(prev => ({
            ...prev,
            redirectUrl: e.target.value
          }))} placeholder="https://example.com/redirect-to-my-success-page" className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm" />
        ...
        <div className="space-y-4">
          ...
          {settings.privateLinks && <div className="mt-4 pl-4">
        ...
        <div className="space-y-4">
          ...
          {settings.offerSeats && <div className="mt-4 pl-4 space-y-4">
        ...
        <div className="space-y-4">
          ...
          {settings.eventTypeColor && <div className="mt-4 pl-4 space-y-3">
              <div>
              ...
              <div>
                ...
                <div className="flex items-center space-x-2">
                  <input type="text" value="fafafa" className="px-3 py-2 border border-gray-300 rounded-lg text-sm w-32" />
                </div>
              </div>
            </div>}
        </div>
