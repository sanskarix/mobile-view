        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="mx-[58px]">
              ...
              fontSize: '14px',
              color: '#384252'
            }} className="w-full border border-gray-300 rounded-lg px-[6px] py-[8px] my-0">
        ...
        <div className="space-y-6">
          ...
          {settings.enableCaptcha && <div className="pl-12">
            ...
            color: '#384252'
              ...
              <select className="px-3 py-2 border border-gray-300 rounded-lg" style={{
            fontSize: '14px'
          }}>
