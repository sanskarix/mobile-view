...
export const Header = ({
  ...
  const getPageContent = () => {
    if (isHomePage) return {
      title: 'Dashboard',
      description: 'Welcome to your scheduling dashboard overview.'
    };
    ...
    if (isAvailabilityPage) return {
      title: 'Availability',
      description: 'Set your available hours and time preferences.'
    };
  ...
  return <header className="h-20 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 sticky top-0 z-50">
      <div className="h-full px-8 flex items-center justify-between w-full">
        ...
        <div className="flex items-center space-x-4 ml-auto">
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            {showHelpDropdown && <div className="absolute right-0 top-full mt-1 w-48 bg-popover border border-border rounded-lg shadow-lg animate-scale-in z-20">
                <div className="py-1">
                  <button onClick={() => handleHelpClick('discord')} className="flex items-center w-full px-3 py-2 text-sm hover:bg-muted transition-colors">
