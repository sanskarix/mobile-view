    ...
    <div className="p-0 max-w-none mx-auto space-y-6">
      <div>
        ...
        <input
          ...
          className="w-full px-2 py-3 border border-border rounded-lg focus:ring-2 focus:ring-ring focus:border-transparent bg-background text-sm text-gray-600"
        />
      </div>
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          ...
          {formData.durations
            .filter(d => !availableDurations.includes(d))
            .map(duration => (
              <div
                key={duration}
                className="flex items-center space-x-1 px-3 py-2 text-sm rounded border bg-primary/10 border-primary text-primary"
              >
                <Clock className="h-3 w-3" />
                <span>{duration} mins</span>
              </div>
