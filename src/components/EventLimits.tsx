  ...
  return (
    <div className="p-0 max-w-none mx-auto space-y-8" style={{ fontSize: '14px', color: '#384252' }}>
      ...
      <div className="space-y-6">
        <h3 className="font-semibold" style={{ fontSize: '16px', color: '#384252' }}>Before event</h3>
        
        <div className="grid grid-cols-2 gap-6">
          <div>
            <label className="block font-medium mb-3" style={{ fontSize: '14px', color: '#384252' }}>Buffer time</label>
            <select 
          ...
          <div>
            <label className="block font-medium mb-3" style={{ fontSize: '14px', color: '#384252' }}>Minimum Notice</label>
      ...
      <div className="border-t border-gray-200 pt-8 space-y-6">
        <h3 className="font-semibold" style={{ fontSize: '16px', color: '#384252' }}>After event</h3>
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div>
            <label className="block font-medium mb-3" style={{ fontSize: '14px', color: '#384252' }}>Time-slot intervals</label>
            <select 
      ...
      <div className="border-t border-gray-200 pt-8 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p style={{ fontSize: '14px', color: '#384252' }}>Limit how many times this event can be booked</p>
          </div>
        ...
        {settings.limitBookingFrequency.enabled && (
          <div className="space-y-4 pl-4">
            {settings.limitBookingFrequency.limits.map((limit, index) => (
              <div key={index} className="flex items-center space-x-3">
                <input 
                  ...
                  className="w-20 px-3 py-2 border border-gray-300 rounded-lg bg-white" 
                  style={{ fontSize: '14px', color: '#384252' }}
                />
                <select 
                  value={limit.period} 
            ...
            <button onClick={addBookingLimit} className="text-blue-600 hover:text-blue-800 flex items-center" style={{ fontSize: '14px' }}>
      ...
      <div className="border-t border-gray-200 pt-8 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p style={{ fontSize: '14px', color: '#384252' }}>Limit total amount of time that this event can be booked</p>
          </div>
        ...
        {settings.limitTotalBookingDuration.enabled && (
          <div className="space-y-4 pl-4">
            ...
            <button onClick={addDurationLimit} className="text-blue-600 hover:text-blue-800 flex items-center" style={{ fontSize: '14px' }}>
              <Plus className="h-4 w-4 mr-1" />
              Add Limit
            </button>
          </div>
      ...
      <div className="border-t border-gray-200 pt-8 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p style={{ fontSize: '14px', color: '#384252' }}>Limit how far in the future this event can be booked</p>
          </div>
        ...
        {settings.limitFutureBookings.enabled && (
          <div className="space-y-4 pl-4">
            ...
            <div style={{ fontSize: '14px', color: '#384252' }}>
              Always {settings.limitFutureBookings.days} days available
            </div>
            
            <div>
              <p className="font-medium mb-3" style={{ fontSize: '14px', color: '#384252' }}>Within a date range</p>
              <div className="flex items-center space-x-3">
                <input 
                  type="text" 
                  ...
                  style={{ fontSize: '14px', color: '#384252' }}
                />
                <span style={{ fontSize: '14px', color: '#384252' }}>-</span>
                <input 
                  type="text" 
      ...
      <div className="border-t border-gray-200 pt-8 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p style={{ fontSize: '14px', color: '#384252' }}>Offset timeslots shown to bookers by a specified number of minutes</p>
          </div>
        ...
        {settings.offsetStartTimes.enabled && (
          <div className="space-y-4 pl-4">
            <div className="flex items-center space-x-3">
              <span style={{ fontSize: '14px', color: '#384252' }}>Offset by</span>
              <input 
                type="number" 
