...
export const EventLimits = () => {
  ...
  return <div className="p-0 max-w-none mx-auto space-y-6" style={{
    fontSize: '14px',
    color: '#384252'
  }}>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="font-semibold mb-2">
                ...
                <CustomSelect value={settings.beforeMinimumNoticeUnit} onValueChange={value => handleValueChange('beforeMinimumNoticeUnit', value)} options={minimumNoticeUnitOptions} className="w-28" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="border border-gray-200 rounded-lg p-6 bg-white">
        ...
        {settings.limitBookingFrequency && <div className="border-t border-gray-100 pt-4 space-y-4">
            <div className="flex items-center space-x-3">
              <input type="number" min="1" value="1" className="w-16 px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white" style={{
            fontSize: '14px'
          }} />
      ...
      <div className="border border-gray-200 rounded-lg p-6 bg-white">
        ...
        {settings.limitFutureBookings && <div className="border-t border-gray-100 pt-4 space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center space-x-2">
                <input type="number" value={settings.futureBookingValue} onChange={e => handleValueChange('futureBookingValue', e.target.value)} className="w-16 px-2 py-1 border border-gray-300 rounded text-sm bg-white" />
            ...
            {settings.futureBookingType === 'date_range' && <div className="ml-6 flex items-center space-x-2">
                <input type="date" value={settings.dateRangeStart} onChange={e => handleValueChange('dateRangeStart', e.target.value)} className="px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white" />
                <span className="text-sm text-gray-600">to</span>
                <input type="date" value={settings.dateRangeEnd} onChange={e => handleValueChange('dateRangeEnd', e.target.value)} className="px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white" />
              </div>}
          </div>}
      </div>
      ...
      <div className="border border-gray-200 rounded-lg p-6 bg-white">
        ...
        {settings.offsetStartTimes && <div className="border-t border-gray-100 pt-4 space-y-3">
            <div>
              <label className="block text-sm font-medium mb-2" style={{
            color: '#384252'
          }}>Offset by</label>
              <div className="flex items-center space-x-2">
                <input type="number" value="0" className="w-20 px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white" style={{
              fontSize: '14px'
            }} />
                <span className="text-sm text-gray-600">Minutes</span>
              </div>
