  ...
  return (
    <div className="flex p-6 bg-card p-8 justify-center">
      <div className="w-full mx-auto p-6 bg-card">
        <div className={`transition-all duration-500 ${isCentered ? 'text-center' : ''}`} style={{ marginLeft: '400px', marginRight: '400px' }}>
          <div className={`w-full space-y-6 border rounded-lg p-6 bg-card shadow-lg ${isCentered ? 'mx-auto max-w-md' : ''}`}>
        ...
        {showTriggerSection && (
          <div className="transition-all duration-500 mt-8 shadow-lg" style={{ marginLeft: '400px', marginRight: '400px' }}>
            <Card>
              <CardHeader>
                  ...
                  <div className="animate-fade-in space-y-4">
                    <div>
                      <Label className="text-sm">
                        ...
                        {triggerOptions.find((t) => t.value === trigger)?.label.toLowerCase().replace('when ', '').replace('before ', '').replace('after ', '')}?
                      </Label>
        ...
        {showActionsSection && (
          <div className="animate-fade-in mt-8 shadow-lg" style={{ marginLeft: '400px', marginRight: '400px' }}>
            <Card>
              <CardHeader>
              ...
              <CardContent className="space-y-4">
                {actions.map((action) => (
                  <Card key={action.id} className="border">
                    <div onClick={() => toggleActionExpanded(action.id)} className="cursor-pointer">
                        ...
                        <div className="p-4">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-3 flex-1">
                              ...
                              {!action.expanded ? (
                                <span>{actionOptions.find((option) => option.value === action.type)?.label}</span>
                              ) : (
                            ...
                            <div className="flex items-center space-x-2">
                              ...
                              {actions.length > 1 && (
                                <Button variant="ghost" size="sm" onClick={(e) => { e.stopPropagation(); removeAction(action.id); }} className="p-2">
