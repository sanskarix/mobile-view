...
export const Apps = () => {
  ...
  return <div className="px-8 pt-0 pb-6 space-y-4 w-full max-w-full">
      {/* Tab Navigation */}
      <div className="">
        <div className="">
      ...
      <div className="">
        <div className="flex gap-4">
          ...
          <div className="flex-1">
            {selectedTab === 'all' ? <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
              ...
              return <div key={app.id} className="bg-card rounded-lg border border-border hover:shadow-md transition-all p-4 aspect-square flex flex-col relative">
                      ...
                      <div className="absolute top-3 right-3 flex gap-1">
                        ...
                        <span className="px-2 py-1 bg-gray-100 text-gray-600 text-xs font-medium rounded">Default</span>
                      </div>
                      ...
                      <div className="flex gap-2 mt-4">
                        ...
                        <Button size="sm" className="flex-1" onClick={() => handleInstallApp(app)}>
                          Install
                        </Button>
                      </div>
                    </div>;
